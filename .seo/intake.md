...
- Primary offer: full-cycle dental clinic in Zaporizhzhia
...
- Primary language: uk
- Additional languages or regions: Russian-language demand exists; site-language decision is pending
- Customer segments: people in Zaporizhzhia evaluating orthodontic treatment; broader dental patients
- Known seasonality:
...
- Platform or framework: static HTML, CSS and JavaScript on GitHub Pages
- Deployment process: `main` in `optidigitalagent/status1`; custom domain `status-dent.zp.ua`
- Approval requirements: implement in reviewable batches and use a draft PR before merging to the live branch
- Legal, medical or brand constraints: no fabricated services, credentials, reviews, outcomes or medical guarantees
